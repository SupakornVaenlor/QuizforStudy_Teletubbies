...
import 'package:loginsystem/m3/sic3_model.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class sic3Screen extends StatefulWidget {
  @override
  State<sic3Screen> createState() => _sic3ScreenState();
}

class _sic3ScreenState extends State<sic3Screen> {
  List<sic3> questionList = [];
  ...
  List<sic3> generateRandomQuestions() {
    List<sic3> allQuestions = getQuestions();
    List<sic3> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "วิทยาศาสตร์ ชั้นมัธยมศึกษาปีที่3",
              style: TextStyle(
