...
import 'package:loginsystem/m3/thai3_model.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class thai3Screen extends StatefulWidget {
  @override
  State<thai3Screen> createState() => _thai3ScreenState();
}

class _thai3ScreenState extends State<thai3Screen> {
  List<thai3> questionList = [];
  ...
  List<thai3> generateRandomQuestions() {
    List<thai3> allQuestions = getQuestions();
    List<thai3> selectedQuestions = [];
