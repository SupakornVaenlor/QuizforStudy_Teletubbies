...
import 'package:loginsystem/m3/soci3_model.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class soci3Screen extends StatefulWidget {
  @override
  State<soci3Screen> createState() => _soci3ScreenState();
}

class _soci3ScreenState extends State<soci3Screen> {
  List<soci3> questionList = [];
  ...
  List<soci3> generateRandomQuestions() {
    List<soci3> allQuestions = getQuestions();
    List<soci3> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "สังคมศึกษา ชั้นมัธยมศึกษาปีที่3",
              style: TextStyle(
