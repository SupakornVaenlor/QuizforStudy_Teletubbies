...
import 'package:loginsystem/m1/sic1_model.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class sic1Screen extends StatefulWidget {
  @override
  State<sic1Screen> createState() => _sic1ScreenState();
}

class _sic1ScreenState extends State<sic1Screen> {
  List<sic1> questionList = [];
  ...
  List<sic1> generateRandomQuestions() {
    List<sic1> allQuestions = getQuestions();
    List<sic1> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "วิทยาศาสตร์ ชั้นมัธยมศึกษาปีที่1",
              style: TextStyle(
