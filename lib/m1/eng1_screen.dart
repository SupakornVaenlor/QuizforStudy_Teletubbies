...
import 'package:loginsystem/m1/eng1_model.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class eng1Screen extends StatefulWidget {
  @override
  State<eng1Screen> createState() => _eng1ScreenState();
}

class _eng1ScreenState extends State<eng1Screen> {
  List<eng1> questionList = [];
  ...
  List<eng1> generateRandomQuestions() {
    List<eng1> allQuestions = getQuestions();
    List<eng1> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "ภาษาอังกฤษ ชั้นมัธยมศึกษาปีที่1",
              style: TextStyle(
