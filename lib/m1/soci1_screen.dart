...
import 'package:loginsystem/m1/soci1_model.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class soci1Screen extends StatefulWidget {
  @override
  State<soci1Screen> createState() => _soci1ScreenState();
}

class _soci1ScreenState extends State<soci1Screen> {
  List<soci1> questionList = [];
  ...
  List<soci1> generateRandomQuestions() {
    List<soci1> allQuestions = getQuestions();
    List<soci1> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "สังคมศึกษา ชั้นมัธยมศึกษาปีที่1",
              style: TextStyle(
