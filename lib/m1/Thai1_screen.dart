...
import 'package:loginsystem/m1/thai1_model.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class Thai1Screen extends StatefulWidget {
  @override
  State<Thai1Screen> createState() => _Thai1ScreenState();
}

class _Thai1ScreenState extends State<Thai1Screen> {
  List<Thai1> questionList = [];
  ...
  List<Thai1> generateRandomQuestions() {
    List<Thai1> allQuestions = getQuestions();
    List<Thai1> selectedQuestions = [];
