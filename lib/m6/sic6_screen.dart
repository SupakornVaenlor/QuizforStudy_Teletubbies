...
import 'package:loginsystem/m6/sic6_model.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class sic6Screen extends StatefulWidget {
  @override
  State<sic6Screen> createState() => _sic6creenState();
}

class _sic6creenState extends State<sic6Screen> {
  List<sic6> questionList = [];
  ...
  List<sic6> generateRandomQuestions() {
    List<sic6> allQuestions = getQuestions();
    List<sic6> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "วิทยาศาสตร์ ชั้นมัธยมศึกษาปีที่6",
              style: TextStyle(
