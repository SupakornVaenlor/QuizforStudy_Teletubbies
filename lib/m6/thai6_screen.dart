...
import 'package:loginsystem/m6/thai6_model.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class thai6Screen extends StatefulWidget {
  @override
  State<thai6Screen> createState() => _thai6creenState();
}

class _thai6creenState extends State<thai6Screen> {
  List<thai6> questionList = [];
  ...
  List<thai6> generateRandomQuestions() {
    List<thai6> allQuestions = getQuestions();
    List<thai6> selectedQuestions = [];
