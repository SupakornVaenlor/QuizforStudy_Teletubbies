...
import 'package:loginsystem/m6/soci6_model.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class soci6Screen extends StatefulWidget {
  @override
  State<soci6Screen> createState() => _soci6creenState();
}

class _soci6creenState extends State<soci6Screen> {
  List<soci6> questionList = [];
  ...
  List<soci6> generateRandomQuestions() {
    List<soci6> allQuestions = getQuestions();
    List<soci6> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "สังคมศึกษา ชั้นมัธยมศึกษาปีที่6",
              style: TextStyle(
