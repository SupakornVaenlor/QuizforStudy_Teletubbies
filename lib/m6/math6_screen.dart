...
import 'package:loginsystem/m6/math6_model.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class math6Screen extends StatefulWidget {
  @override
  State<math6Screen> createState() => _math6creenState();
}

class _math6creenState extends State<math6Screen> {
  List<math6> questionList = [];
  ...
  List<math6> generateRandomQuestions() {
    List<math6> allQuestions = getQuestions();
    List<math6> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "คณิตศาสตร์ ชั้นมัธยมศึกษาปีที่6",
              style: TextStyle(
