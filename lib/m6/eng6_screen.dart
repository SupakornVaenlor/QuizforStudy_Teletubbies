...
import 'package:loginsystem/m6/eng6_model.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class eng6Screen extends StatefulWidget {
  @override
  State<eng6Screen> createState() => _eng6creenState();
}

class _eng6creenState extends State<eng6Screen> {
  List<eng6> questionList = [];
  ...
  List<eng6> generateRandomQuestions() {
    List<eng6> allQuestions = getQuestions();
    List<eng6> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "ภาษาอังกฤษ ชั้นมัธยมศึกษาปีที่6",
              style: TextStyle(
