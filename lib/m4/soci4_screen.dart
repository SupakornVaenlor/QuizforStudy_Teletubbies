...
import 'package:loginsystem/m4/question_social_m4.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class soci4Screen extends StatefulWidget {
  @override
  State<soci4Screen> createState() => _soci4ScreenState();
}

class _soci4ScreenState extends State<soci4Screen> {
  List<soci4> questionList = [];
  ...
  List<soci4> generateRandomQuestions() {
    List<soci4> allQuestions = getQuestions();
    List<soci4> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "สังคมศึกษา ชั้นมัธยมศึกษาปีที่4",
              style: TextStyle(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: Color.fromARGB(217, 219, 219, 29),
