...
import 'package:loginsystem/m4/question_math_m4.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class math4Screen extends StatefulWidget {
  @override
  State<math4Screen> createState() => _math4ScreenState();
}

class _math4ScreenState extends State<math4Screen> {
  List<math4> questionList = [];
  ...
  List<math4> generateRandomQuestions() {
    List<math4> allQuestions = getQuestions();
    List<math4> selectedQuestions = [];
