...
import 'package:loginsystem/m4/question_thai_m4.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class thai4Screen extends StatefulWidget {
  @override
  State<thai4Screen> createState() => _thai4ScreenState();
}

class _thai4ScreenState extends State<thai4Screen> {
  List<thai4> questionList = [];
  ...
  List<thai4> generateRandomQuestions() {
    List<thai4> allQuestions = getQuestions();
    List<thai4> selectedQuestions = [];
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: Color.fromARGB(198, 219, 86, 29),
