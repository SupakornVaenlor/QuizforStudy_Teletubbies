...
import 'package:loginsystem/m5/5_Society.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class soci5Screen extends StatefulWidget {
  @override
  State<soci5Screen> createState() => _soci5ScreenState();
}

class _soci5ScreenState extends State<soci5Screen> {
  List<soci5> questionList = [];
  ...
  List<soci5> generateRandomQuestions() {
    List<soci5> allQuestions = getQuestions();
    List<soci5> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "สังคมศึกษา ชั้นมัธยมศึกษาปีที่5",
              style: TextStyle(
