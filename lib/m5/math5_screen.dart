...
import 'package:loginsystem/m5/5_Math.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class math5Screen extends StatefulWidget {
  @override
  State<math5Screen> createState() => _math5ScreenState();
}

class _math5ScreenState extends State<math5Screen> {
  List<math5> questionList = [];
  ...
  List<math5> generateRandomQuestions() {
    List<math5> allQuestions = getQuestions();
    List<math5> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "คณิตศาสตร์ ชั้นมัธยมศึกษาปีที่5",
              style: TextStyle(
