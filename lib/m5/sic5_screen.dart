...
import 'package:loginsystem/m5/5_Science.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class sic5Screen extends StatefulWidget {
  @override
  State<sic5Screen> createState() => _sic5ScreenState();
}

class _sic5ScreenState extends State<sic5Screen> {
  List<sic5> questionList = [];
  ...
  List<sic5> generateRandomQuestions() {
    List<sic5> allQuestions = getQuestions();
    List<sic5> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "วิทยาศาสตร์ ชั้นมัธยมศึกษาปีที่5",
              style: TextStyle(
