...
import 'package:loginsystem/m5/5_Thai.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class thai5Screen extends StatefulWidget {
  @override
  State<thai5Screen> createState() => _thai5ScreenState();
}

class _thai5ScreenState extends State<thai5Screen> {
  List<thai5> questionList = [];
  ...
  List<thai5> generateRandomQuestions() {
    List<thai5> allQuestions = getQuestions();
    List<thai5> selectedQuestions = [];
