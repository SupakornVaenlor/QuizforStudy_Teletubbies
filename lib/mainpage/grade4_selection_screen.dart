...
import 'package:loginsystem/m1/soci1_screen.dart';
import 'package:loginsystem/m2/soci2_screen.dart';
import 'package:loginsystem/m3/soci3_screen.dart';
import 'package:loginsystem/m4/soci4_screen.dart';
import 'package:loginsystem/m5/soci5_screen.dart';
import 'package:loginsystem/m6/soci6_screen.dart';
...
class GradeSelection4Screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          onPressed: () {
            ...
            switch (grade) {
              case 'ชั้นมัธยมศึกษาปีที่ 1':
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => soci1Screen()),
                );
                break;
              case 'ชั้นมัธยมศึกษาปีที่  2':
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => soci2Screen()),
                );
                break;
              case 'ชั้นมัธยมศึกษาปีที่ 3':
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => soci3Screen()),
                );
                break;
              case 'ชั้นมัธยมศึกษาปีที่ 4':
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => soci4Screen()),
                );
                break;
              case 'ชั้นมัธยมศึกษาปีที่ 5':
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => soci5Screen()),
                );
                break;
              case 'ชั้นมัธยมศึกษาปีที่ 6':
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => soci6Screen()),
                );
                break;
              default:
                break;
