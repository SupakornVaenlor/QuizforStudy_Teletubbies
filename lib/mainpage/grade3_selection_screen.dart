...
import 'package:loginsystem/m1/sic1_screen.dart';
import 'package:loginsystem/m2/sic2_sreen.dart';
import 'package:loginsystem/m3/sic3_screen.dart';
import 'package:loginsystem/m4/sic4_screen.dart';
import 'package:loginsystem/m5/sic5_screen.dart';
import 'package:loginsystem/m6/sic6_screen.dart';
...
class GradeSelection3Screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          onPressed: () {
            ...
            switch (grade) {
              case 'ชั้นมัธยมศึกษาปีที่ 1':
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => sic1Screen()),
                );
                break;
              case 'ชั้นมัธยมศึกษาปีที่  2':
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => sci2Screen()),
                );
                break;
              case 'ชั้นมัธยมศึกษาปีที่ 3':
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => sic3Screen()),
                );
                break;
              case 'ชั้นมัธยมศึกษาปีที่ 4':
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => sci4Screen()),
                );
                break;
              case 'ชั้นมัธยมศึกษาปีที่ 5':
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => sic5Screen()),
                );
                break;
              case 'ชั้นมัธยมศึกษาปีที่ 6':
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => sic6Screen()),
                );
                break;
              default:
                break;
