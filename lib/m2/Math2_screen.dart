...
import 'package:loginsystem/m2/2_Math.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class math2Screen extends StatefulWidget {
  @override
  State<math2Screen> createState() => _math2ScreenScreen();
}

class _math2ScreenScreen extends State<math2Screen> {
  List<math2> questionList = [];
  ...
  List<math2> generateRandomQuestions() {
    List<math2> allQuestions = getQuestions();
    List<math2> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "คณิตศาสตร์ ชั้นมัธยมศึกษาปีที่2",
              style: TextStyle(
