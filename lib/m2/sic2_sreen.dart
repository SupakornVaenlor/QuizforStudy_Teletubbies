...
import 'package:loginsystem/m2/2_Science.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class sci2Screen extends StatefulWidget {
  @override
  State<sci2Screen> createState() => _sci2Screen();
}

class _sci2Screen extends State<sci2Screen> {
  List<sci2> questionList = [];
  ...
  List<sci2> generateRandomQuestions() {
    List<sci2> allQuestions = getQuestions();
    List<sci2> selectedQuestions = [];
