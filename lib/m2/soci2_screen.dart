...
import 'package:loginsystem/m2/2_Society.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class soci2Screen extends StatefulWidget {
  @override
  State<soci2Screen> createState() => _soci2Screen();
}

class _soci2Screen extends State<soci2Screen> {
  List<soci2> questionList = [];
  ...
  List<soci2> generateRandomQuestions() {
    List<soci2> allQuestions = getQuestions();
    List<soci2> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "สังคมศึกษา ชั้นมัธยมศึกษาปีที่2",
              style: TextStyle(
