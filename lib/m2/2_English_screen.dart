...
import 'package:loginsystem/m2/2_English.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class English2Screen extends StatefulWidget {
  @override
  State<English2Screen> createState() => _English2Screen();
}

class _English2Screen extends State<English2Screen> {
  List<English2> questionList = [];
  ...
  List<English2> generateRandomQuestions() {
    List<English2> allQuestions = getQuestions();
    List<English2> selectedQuestions = [];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "ภาษาอังกฤษ ชั้นมัธยมศึกษาปีที่2",
              style: TextStyle(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: Color.fromARGB(220, 54, 197, 222),
