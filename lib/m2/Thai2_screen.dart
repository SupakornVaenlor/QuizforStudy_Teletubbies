...
import 'package:loginsystem/m2/2_Thai.dart';
import 'package:loginsystem/mainpage/mainpage.dart';

class Thai2Screen extends StatefulWidget {
  @override
  State<Thai2Screen> createState() => _Thai2Screen();
}

class _Thai2Screen extends State<Thai2Screen> {
  List<Thai2> questionList = [];
  ...
  List<Thai2> generateRandomQuestions() {
    List<Thai2> allQuestions = getQuestions();
    List<Thai2> selectedQuestions = [];
